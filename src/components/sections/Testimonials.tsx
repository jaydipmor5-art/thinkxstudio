...
export default function Testimonials() {
  const reviews: TestimonialCard[] = [
    {
      ...
      source: "direct",
      quote: "ThinkX OS completely transformed how we track development. Seeing active Git commits and UI progress directly in our dashboard built so much trust. Simply outstanding work by the team!",
    ...
    },
    {
      ...
      source: "direct",
      quote: "Their CRM integration and live client operating system are industry-defining. We manage 12 site timelines inside our portal with ease. Outstanding automation pipelines that saved us hours every week.",
    ...
    },
    {
      ...
      source: "google",
      stars: 5,
      quote: "The hospital ERP software they built resolved our record latency issues. The AI proposal generator was incredibly accurate on pricing and timeline, and they hit every milestone on time.",
    ...
    },
    {
      ...
      company: "GlowJewels",
      source: "linkedin",
      quote: "We commissioned Estate3D virtual showrooms for our jewelry catalog. Sales increased significantly in our offline markets. Highly recommend the ThinkXstudio team for any digital transformation!",
    ...
    },
    {
      ...
      source: "google",
      stars: 5,
      quote: "Implemented QR ordering and kitchen monitors for all 8 locations. Order error refunds dropped significantly. The dashboard invoice system is super clean and our staff adopted it in one day.",
    ...
    },
    {
      ...
      source: "linkedin",
      quote: "They handled our video reels and graphic design assets with elite GSAP animations. Outstanding brand identity work, lightning-fast communications, and the final delivery exceeded our expectations.",
  ...
  const gridReviews = reviews.slice(2);

  return (
    <section id="testimonials" className="py-24 relative overflow-hidden bg-transparent scroll-reveal">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Featured Reviews (Row of 2 large cards) */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          {featuredReviews.map((card, idx) => (
            <div
              key={idx}
            ...
            >
              ...
              <div className="flex items-start justify-between w-full relative z-10">
                ...
                <div className="flex items-center gap-1 filter drop-shadow-[0_0_3px_rgba(251,191,36,0.3)]">
                  {[...Array(5)].map((_, i) => (
              ...
              {/* Quote */}
              <div className="relative z-10 mt-6 mb-8 pr-4">
                <blockquote className="text-sm text-zinc-700 dark:text-zinc-300 leading-relaxed font-semibold">
                  "{card.quote}"
                </blockquote>
              </div>
          ...
          {gridReviews.map((card, idx) => {
            ...
            return (
              ...
              >
                ...
                <span className="absolute top-2 left-4 text-zinc-200/30 dark:text-zinc-800/10 text-7xl font-serif font-black select-none pointer-events-none z-0">
                  "
                </span>
                ...
                <div className="relative z-10 flex items-center justify-between mb-5 w-full">
                  ...
                  <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-zinc-105/90 dark:bg-zinc-900/75 border border-zinc-200/50 dark:border-zinc-800/60 shadow-sm text-[8px] font-mono font-bold text-zinc-550 dark:text-zinc-400">
                    ...
                    <span className="capitalize">{card.source === "direct" ? "verified" : card.source}</span>
                  </div>
                </div>
                ...
                <div className="relative z-10 flex items-center gap-3 pt-4 border-t border-zinc-200/50 dark:border-zinc-900/60 w-full">
                  <div className={`w-8 h-8 rounded-lg border flex items-center justify-center flex-shrink-0 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3 ${card.brandColor}`}>
                    {card.logoSvg}
                  </div>
