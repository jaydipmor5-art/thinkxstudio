    ...
    <footer className="border-t border-zinc-800/60 bg-[#070912] relative overflow-hidden py-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center w-full mb-16 select-none pointer-events-none">
          <h2 className="text-4xl sm:text-6xl md:text-7.5xl font-black tracking-tighter uppercase leading-none bg-clip-text text-transparent bg-gradient-to-r from-white via-[#FAB818] via-zinc-300 to-white bg-[size:200%_auto] animate-[shimmer_6s_linear_infinite]">
